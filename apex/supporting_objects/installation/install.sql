...
@@application/shared_components/files/screenshot_2025_09_23_164722_png.sql
@@application/plugin_settings.sql
@@application/shared_components/security/authorizations/administration_rights.sql
@@application/shared_components/security/authorizations/authroization_usingauthentication.sql
@@application/shared_components/navigation/navigation_bar.sql
@@application/shared_components/logic/application_items/app_username.sql
@@application/shared_components/logic/application_items/app_userrole.sql
@@application/shared_components/logic/application_settings.sql
@@application/shared_components/navigation/tabs/standard.sql
@@application/shared_components/navigation/tabs/parent.sql
@@application/shared_components/user_interface/lovs/destination.sql
@@application/shared_components/user_interface/lovs/source.sql
...
@@application/shared_components/security/authentications/authenticating_user.sql
